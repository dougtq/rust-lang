...
const FOOD_COLOR : Color = [0.90,0.00, 0.00, 1.];
const BORDER_COLOR : Color = [0.0,0.00, 0.00, 1.];
...
impl Game {
    ...
    fn check_snake_status (&self, dir: Option<Direction>) -> bool {
        //# Bool True eq Alive
        //# Bool False eq Dead
    ...
    fn update_snake (&mut self, dir: Option<Direction>) {
        if self.check_snake_status(dir) {
